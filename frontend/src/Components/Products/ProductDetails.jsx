                ...
                <div className="flex gap-2 mt-2">
                    {selectedProduct.colors.map((color) => (
                        <button key={color}
                         ...
                         className={` cursor-pointer w-8 h-8 rounded-full border ${selectedColor === color ? "border-4 border-black" : "border-gray-300"}`}
                ...
                <div className="flex gap-2 mt-2">
                    {selectedProduct.sizes.map((size) => (
                        <button
                         ...
                         key={size} className={`px-4 py-2 rounded border cursor-pointer ${selectedSize === size ? "bg-black text-white" : ""}`}>{size}</button>
                    ))}
                </div>
              </div>
              <div className="mb-6">
                ...
                <div className="flex items-center space-x-4 mt-2">
                    <button
                     ...
                     className="px-2 py-2 bg-gray-200 rounded text-lg" >-</button>
