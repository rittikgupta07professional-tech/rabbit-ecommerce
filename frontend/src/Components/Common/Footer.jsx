...
const Footer = () => {
  return (
    <footer className='border-t py-12 lg:px-6'>
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
            <div>
                ...
                <p className='font-medium text-sm text-gray-600 mb-6'>
                    Sign upn and get 10% off on your first order.
                </p>
                {/* Newsletter form */}
                <form className='flex'>
                    <input
                    ...
                    className='p-3 w-full text-sm border-t border-l border-b border-gray-300
                     rounded-l-md focus:oultiner-none focus:ring-2 focus:ring-gray-500 transition-all' 
                    />
